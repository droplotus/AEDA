import math
def dy(x,y,z):
    return -math.exp(-0.5/(z+273))*y

def dz(x,y,z):
    return 30*math.exp(-0.5/(z+273))*y-0.5*(z-20)
...
#print(euler(0.25,0,2.5,25,0.5,dy,dz))
print(convergence_quotient(0.125,0.5,1.40778,54,25499,dy,dz,euler))